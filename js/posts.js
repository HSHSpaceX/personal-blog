...
window.BLOG_POSTS = [
  {
    ...
    content: `<p>很多人以为个人博客一定要买服务器、装 WordPress，其实对于以写作和记录为主的博客，静态网站已经足够好用。它速度快、几乎不需要维护，而且可以免费托管在任何静态平台上。</p>
      ...
      <ul>
        ...
        <li>加载快：文件体积小，全球 CDN 都能轻松承担。</li></ul><h2>个性化</h2><div>这里我采用了液态玻璃设计（深色明显）</div><div><img src="https://raw.githubusercontent.com/HSHSpaceX/personal-blog/main/assets/posts/img-20260912-1538-2tud.jpeg" alt="插图"></div><div><span style="color: var(--ink); font-family: var(--font); font-size: 22px; font-weight: 700; letter-spacing: -0.015em;">本站的文件结构</span></div>
